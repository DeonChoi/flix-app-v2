...
flix is a website that pulls data from https://www.themoviedb.org.
Users are able to search for films by keyword, register and login to account via Google Authentication, and save movies to their 'watchlist'.

This is a remake of a project I made nearly 2 years ago:
https://github.com/DeonChoi/flix-app
...
I am also choosing to use NoSQL (like many of my previous projects) instead of SQL for this project.
